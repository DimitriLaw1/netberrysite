...
if(isset($_POST['update_instagram'])) {
    ...
    $instagram_query = mysqli_query($con, "UPDATE users SET instagram_name='$instagram_name' WHERE username='$userLoggedIn'");
    $message = "Details updated!<br><br>";
}
...
if(isset($_POST['update_school'])) {
    ...
    $school_query = mysqli_query($con, "UPDATE users SET school_name='$school_name' WHERE username='$userLoggedIn'");
    $message = "Details updated!<br><br>";
}
